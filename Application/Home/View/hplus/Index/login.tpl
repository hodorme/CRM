...
<head>
    ...
    <link href="__ADDONS__/Hplus/css/plugins/sweetalert/sweetalert.css" rel="stylesheet">
    <!--[if lt IE 9]>
    ...
    <block name="main">
        <div>
            <div id="imgbox" style="width:300px;height:151px;;margin-top:90px;margin-bottom:30px;">
                <img src="__IMG__/logo.png" alt=""style="width:300px;height:151px;">
            </div>
...
<script src="__ADDONS__/Hplus/js/plugins/sweetalert/sweetalert.min.js"></script>
<script>
    $(function(){
