...
<!-- 框架开始 -->
  ...
  <section class='content'>
    ...
    <form method='post' id="addForm" action='' class="layui-form">
        <input type=hidden id="oid" name="oid" value="<?php echo ($oid); ?>" checked>
                ...
                <td>
                    <div class="layui-input-inline">
                        <select id="why" name="why" col="2" size="15" lay-filter="why">
                            ...
                            <?php $_result=ShowList('class','parid=1661','id');if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"<?php if($vo['id'] == 1662): ?>selected="selected"<?php endif; ?>><?php echo ($vo["classname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                </td>
            </tr>
