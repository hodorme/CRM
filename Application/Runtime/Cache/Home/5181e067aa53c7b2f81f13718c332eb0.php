...
<!-- 框架开始 -->
  ...
  <section class='content'>
            ...
            <div class="layui-form-inline" >
                ...
                <div class="layui-input-inline" style="width: 150px">
                    <select id='reson' lay-filter="searchselect" col="0">
                        ...
                        <?php $_result=ShowList('class','parid=1661','id');if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["classname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </div>
                <div class="layui-input-inline" style="width: 150px">
    ...
    <div class="bg-info msgbox">
        Updated information: Total exhibiting space sold:<b style="color:red;"><span id="allTotal1"></span> </b></a>㎡
        <!--当前统计:
