    ...
    <div class="footerbtn">
        ...
        <table class='table table-striped'>
            ...
            <tr>
                ...
                <td  class="form-inline">
                    <div class="input-group">
                        <div class="layui-input-inline">
                            <input type="text" name="acreage" id="acreage" value="<?php echo ($result['acreage']); ?>" class="layui-input" style="width: 168px">
                        </div>
            ...
            <tr>
                ...
                <td>
                    <input id="qydate" name="qydate"  lay-verify="qydate" value="<?php echo ($result['qydate']); ?>" class="layui-input" onclick="layui.laydate({elem: this, festival: true})" style="width: 168px" >
                </td>
                <td align="right">Est. payment date</td>
                <td>
                    <input id="paymentdate" name="paymentdate" value="<?php echo ($result['paymentdate']); ?>"  class="layui-input" onclick="layui.laydate({elem: this, festival: true})" style="width: 168px" >
                </td>
            </tr>
            <tr>
