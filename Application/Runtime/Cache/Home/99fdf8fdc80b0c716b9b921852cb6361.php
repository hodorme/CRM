    ...
    <table class='table table-striped'>
      <tr>
        ...
        <td colspan="3" style="line-height:32px;   ">
            <input id="title" name="title" type="text" class="layui-input" value="<?php echo ($res['title']); ?>" style="width: 470px;"/>
        </td>
      </tr>
      <tr>
        ...
        <td>
            <div class="input-group" style="width: 200px">
                <input id="mbmianji" name="mbmianji" type="text" class="layui-input" value="<?php echo ($res["mbmianji"]); ?>" />
      ...
      <tr>
        ...
        <td colspan="3" class="form-inline"><div class="input-group">
			  <span class="input-group-addon">starttime</span><input id="starttime" name="starttime" value="<?php echo ($res["starttime"]); ?>"  type="text" class='layui-input' lay-verify="required" onclick="layui.laydate({elem: this, festival: true})" />
			  </div>
		<div class="input-group">
			  <span class="input-group-addon">endtime</span>
            <input id="endtime" name="endtime" type="text" class='layui-input' value="<?php echo ($res["endtime"]); ?>" onclick="layui.laydate({elem: this, festival: true})" />
			   </div>
			  </td>
      </tr>
      <tr>
        ...
        <td colspan="3" class="form-inline">
            <input id="website" name="website" type="text" size="40" value="<?php echo ($res["website"]); ?>" class="form-control layui-input" />
            <span class="addmsg">(Example:"www.jrexpo.com")</span></td>
      </tr>
      <tr>
        <td align="right"><strong>Exhibition Name</strong></td>
        <td colspan="3" class="form-inline">
            <input id="hallname" name="hallname" value="<?php echo ($res["hallname"]); ?>" type="text" size="40" class="form-control layui-input" />
          </td>
      </tr>
      <tr>
        <td align="right"><strong>Exhibition Address</strong></td>
        <td colspan="3" class="form-inline">
            <input id="halladd" name="halladd" type="text" value="<?php echo ($res["halladd"]); ?>" style="width: 275px"  class="form-control layui-input" />
            <span class="addmsg">(Google Maps)</span>
        </td>
      </tr>
      <tr>
        <td align="right" valign="top"><strong>Exhibition Introduction</strong></td>
        <td colspan="3"><textarea id="profile" name="profile" rows="5" class="layui-textarea" style="width: 650px"><?php echo ($res["profile"]); ?></textarea>
         </td>
      </tr>
