...
<!-- 框架开始 -->
  ...
  <section class='content'>
    ...
    <ul class="nav nav-tabs">
        <li class="active"><a href=""><?php echo ($modular); ?></a></li>
    </ul>
...
<script>
    ...
    $(".addExpoFun").click(function(){
        ...
        var url ="<?php echo U('Expo/add',array('czid'=>$czid));?>";
        _layerOpen(url, title, '65%', '80%');
    });
    $(".editFun").click(function(){
        var title = "Edit Item";
        var url ="<?php echo U('Project/edit',array('czid'=>$czid));?>";
        _layerOpen(url, title, '65%', '80%');
    });
	 /*初始化表格*/
    var table = $('#ListTbl').DataTable({
        ...
        searching: false,
        autoWidth: false,
        ajax: "?show=showExpo&czid=<?php echo ($czid); ?>"
    });
    /*调用自定义 */
    _customSearch(table);
    /*单击选择 */
    ...
    $(document).on("click", ".edit", function () {
        ...
        var url ="<?php echo U('Expo/edit');?>?czid="+czid;
