...
var WriteHead=1;
document.write('<iframe style="position:absolute;width:206px;display:none;z-index:99999" name="divCalendar" id="divCalendar" frameborder="0" scrolling="no"></iframe>')
...
'{var Html="",s,e,obj,d;'+
'if(key=="Y"){s=sy;e=ey;obj="SelectYearItem";d="年";}if(key=="M"){s=sm;e=em;obj="SelectMonthItem";d="月";}'+
...
'<li style="width:144px;background:#FFF;padding-bottom:1px;" id="SelectArea"><div id="sYear" onclick="ShowSelect(\'SelectYear\',\'Y\');">'+year+'年</div><div id="SArr" onclick="ShowSelect(\'SelectYear\',\'Y\');"><font face="Webdings">&#8595;</font></div>'+
'<div id="sMonth" onclick="ShowSelect(\'SelectMonth\',\'M\');">'+MonthText[month]+'月</div><div id="SArr" onclick="ShowSelect(\'SelectMonth\',\'M\');"><font face="Webdings">&#8595;</font></div>';
content+='</li>'+
'<li><a href="javascript:parent.Calendar_hide();">关闭</a></li></ul>'+
'<div id="Tools"><ul>'+
...
if(Calendar_obj2){content+='<li style="width:42px;"><a href="javascript:parent.Calendar_GetDate('+year+','+month+',0);">当月</a></li>'+
'<li style="width:43px;"><a href="javascript:parent.Calendar_GetDate('+date.getFullYear()+','+(date.getMonth()+1)+','+date.getDate()+');">当前</a></li>';}
else{content+='<li style="width:86px;"><a href="javascript:parent.Calendar_GetDate('+date.getFullYear()+','+(date.getMonth()+1)+','+date.getDate()+');">当前日期</a></li>';}
...
'</ul></div>'+
'<div id="Title"><ul><li style="color:#F00;">周日</li><li>周一</li><li>周二</li><li>周三</li><li>周四</li><li>周五</li><li style="color:#F00;">周六</li></ul></div>'+
